            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                ...
                {(source.url || source.magnet) && (
                    <div className="flex items-center gap-2 justify-end sm:shrink-0">
                        {source.url && (
                            <PlayUrlButton url={source.url} title={mediaTitle} onOpenPreview={onOpenPreview} onPlay={onPlaybackStart} />
                        )}
...
export function Sources({ imdbId, mediaType = "movie", tvParams, className, mediaTitle, onPlaybackStart }: SourcesProps) {
