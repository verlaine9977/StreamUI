                ...
                {isLoading
                    ...
                    : episodes?.map((episode) => (
                          <EpisodeCard
                              ...
                              posterUrl={media.images?.poster?.[0] ? `https://${media.images.poster[0]}` : undefined}
                              defaultOpen={autoOpenEpisode === episode.number}
                          />
                      ))}
            </div>
        </div>
...
export const ShowDetails = memo(function ShowDetails({ media, mediaId }: ShowDetailsProps) {
    ...
    const autoOpenEpisode = episodeParam ? parseInt(episodeParam, 10) : undefined;
    ...
    return (
        <div className="space-y-12">
            ...
            <section className="space-y-6">
                ...
                <EpisodesSection selectedSeason={selectedSeason} mediaId={mediaId} media={media} autoOpenEpisode={autoOpenEpisode} />
            </section>
