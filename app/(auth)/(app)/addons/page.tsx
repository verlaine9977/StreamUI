...
// Usenet Streamer default manifest URL
const USENET_STREAMER_URL = "https://mystreamer.controld.live/MySecureStream77/manifest.json";
            ...
            <section className="space-y-4">
                ...
                {!isAdding ? (
                    <div className="grid gap-4 sm:grid-cols-2">
                        ...
                        {/* Usenet Streamer preset card */}
                        <button
                            onClick={() => handleAddAddon(USENET_STREAMER_URL)}
                            disabled={validating}
                            className="group relative flex flex-col items-center justify-center gap-3 rounded-sm border border-border/50 p-6 text-center transition-all duration-300 hover:border-blue-500/50 hover:bg-blue-500/5 disabled:opacity-50 disabled:cursor-not-allowed">
                            <div className="flex h-12 w-12 items-center justify-center rounded-sm bg-blue-500/10 transition-colors group-hover:bg-blue-500/20">
                            ...
                            <div>
                                <p className="text-sm font-light">Add Usenet Streamer</p>
                                <p className="text-xs text-muted-foreground mt-1">Stream from Usenet sources</p>
                            </div>
                        </button>
                    </div>
                ) : (
